...
'  Updated 02-Feb-2009 to use native MySendKeys in Windows 95.
...
' Win32 API Declarations
 ...
 Declare Function SendInput Lib "user32" (ByVal nInputs As Long, pInputs As Any, ByVal cbSize As Long) As Long
...
Global Const VER_PLATFORM_WIN32_WINDOWS As Long = &H1
Global Const VER_PLATFORM_WIN32_NT As Long = &H2
...
Public Sub MySendKeys(Data As String, Optional Wait As Boolean)
   ...
   ' Defer to native MySendKeys if SendInput not supported.
   OS.dwOSVersionInfoSize = Len(OS)
   Call GetVersionEx(OS)
   '2013/12/09 quitado manolo
...
'         Call MySendKeys(Data, Wait)
'         Exit Sub
'      End If
'   End If
   '2013/12/09 quitado manolo fin
